...
const Dashboard = () => {
  ...
  return (
    <div class="col main pt-5 mt-3">
      <p class="lead d-none d-sm-block">View,Edit and Add Courses</p>
      ...
      <div class="row mb-3">
        <div class="col-xl-8 col-sm-6 py-2">
          <div class="text-right card text-white bg-light h-100">
            <div class="card-body">
              <h3 class="text-info text-center ">Welcome</h3>
              <h5 class="text-info text-center ">to </h5>
              <h4 class="text-info text-center ">DigiCerti </h4>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 py-2">
          <div class="text-right card text-white bg-info h-100">
            <div class="card-body">
              ...
              <h6 class="text-center text-uppercase">Certifications</h6>
            </div>
          </div>
        </div>
      </div>
